...
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("cliphist list | rofi -dmenu -p \"Clipboard History: \" | cliphist decode | wl-copy"))
...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.window.fullscreen({ mode = "fullscreen", action = "toggle" }))
hl.bind(mainMod .. " + D", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + H", hl.dsp.window.pin())
hl.bind("ALT + Tab", hl.dsp.window.cycle_next({ next = true }))

-- Close all notifications
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("dunstctl close-all"))
...
-- Take screenshots
hl.bind(mainMod .. " + " .. SCREENSHOT_KEY, hl.dsp.exec_cmd("hyprshot --freeze -m region -o \"$HOME/screenshots/\""))
hl.bind(mainMod .. " + SHIFT + " .. SCREENSHOT_KEY, hl.dsp.exec_cmd("hyprshot --freeze -m region --raw | satty -f -"))
-- Toggle screen
hl.bind(mainMod .. " + F1", hl.dsp.dpms({ action = "toggle" }), { locked = true })
...
-- Requires playerctl
hl.bind(mainMod .. " + K", hl.dsp.exec_cmd("playerctl play-pause"))
